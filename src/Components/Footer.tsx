  ...
  return (
    ...
    <footer className="bg-[#050505] text-neutral-400 py-16 border-t border-neutral-900 relative">
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12 text-xs uppercase tracking-[0.15em] font-medium mb-12">
          <Link
            href="/"
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="group relative flex items-center justify-center">
              <div className="text-neutral-500 hover:text-amber-400 transition-colors duration-300 cursor-help">
                <svg
              ...
              <span className="absolute -top-10 scale-0 group-hover:scale-100 transition-transform duration-200 bg-neutral-900 border border-neutral-800 text-neutral-300 text-[10px] uppercase tracking-wider py-1.5 px-3 rounded whitespace-nowrap">
                {t("tooltips.confidentiality")}
              </span>
            </div>

            {/* Drapeau Français */}
            <div className="group relative flex items-center justify-center">
              <div className="cursor-help opacity-70 hover:opacity-100 transition-opacity duration-300 filter hover:grayscale-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 480"
                  className="h-4 w-6 rounded-[2px] overflow-hidden"
                >
